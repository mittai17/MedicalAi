...
/**
 * SwasthAI Typography System
 *
 * Uses Google Fonts "Inter" as the primary typeface for its excellent
 * readability on mobile screens, particularly at smaller sizes used in
 * healthcare data displays.
 *
 * Falls back to system default sans-serif if Google Fonts are unavailable
 * (critical for offline-first behavior).
 */

private val googleFontProvider = GoogleFont.Provider(
    providerAuthority = "com.google.android.gms.fonts",
    providerPackage = "com.google.android.gms",
    certificates = com.swasthai.app.R.array.com_google_android_gms_fonts_certs
)
...
val SwasthAITypography = Typography(
    // ── Display ──
